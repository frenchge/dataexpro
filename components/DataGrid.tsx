                  ...
                  <td className="px-6 py-3 text-sm border-r border-slate-100">
                    {record.sourceType ? (
                      record.sourceType === 'pdf' ? (
                        <span
                          className="flex items-center gap-1.5 px-2 py-1 rounded-md text-xs font-medium bg-red-50 text-red-500 cursor-default"
                          title="Source PDF stockée (utilisée pour la ré-extraction)"
                        >
